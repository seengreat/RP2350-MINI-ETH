...
void W5500_Config() {
    ...
    uint8_t pc_ip[4] = {192, 168, 1, 11};  //Replace it with the actual IP address of the PC.
...
bool Socket_Config() {
    ...
    Serial.print("UDP Server started on port 5000\r\n");
    return true;
}
...
void setup() {
    ...
    Serial.println("UDP Server mode test");
    W5500_Gpio_Init(); 
    // Initialize the SPI
...
void loop() {
    ...
    if(rx_size > 0){
        ...
        if (bytes_read > 0) {
            ...
            Serial.print("TX buffer is full\r\n");
        }
    }
    delay(1000);
}
